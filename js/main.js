...
function initScrollSuave() {
  const seta = document.querySelectorAll(".texto-foto ion-icon");
  function scrollToSection(event) {
    event.preventDefault();
    const ionIcon = currentTarget.getAttribute("ion-icon");
    const section = document.querySelector(ion - icon);
    console.log("section");
  ...
  seta.onclick((flecha) => {
    flecha.addEventListener("click", scrollToSection);
  });
}
initScrollSuave();
